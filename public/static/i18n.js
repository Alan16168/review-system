...
const translations = {
  zh: {
    ...
    'templateDeletedWithReassign': '模板已删除，{count}个复盘已重新分配到默认模板',
  ...
  en: {
    ...
    'templateDeletedWithReassign': 'Template deleted successfully. {count} review(s) were reassigned to the default template',
