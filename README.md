...
- **最新部署 ID**: https://7e11e2a2.review-system.pages.dev
- **GitHub 仓库**: https://github.com/Alan16168/review-system
- **版本**: ✅ V5.24.0 - 多语言支持（增强语言切换器）
...
### 开发环境
- **应用 URL**: https://8f163758.review-system.pages.dev
- **Git Commit**: ✅ V5.25.0 (删除群体类型，优化团队选择逻辑)
- **本地端口**: 3000 (PM2 管理)
- **数据库状态**: 
...
- **更新内容**: 
  - ✅ **删除群体类型并优化团队选择 (V5.25.0 - 2025-11-11)**：
    - **数据库结构调整**：
