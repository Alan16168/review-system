-- Migration: Remove Chinese fields from templates and template_questions
...
CREATE TABLE template_questions_backup AS SELECT * FROM template_questions;
...
SELECT id, name_en, description_en, is_default, is_active, created_at, updated_at
...
-- Step 7: Migrate data from backup (using English column as primary)
...
SELECT 
  id, template_id, question_number, question_text_en,
  question_type, options, correct_answer, answer_length,
  datetime_value, datetime_title, datetime_answer_max_length, created_at
